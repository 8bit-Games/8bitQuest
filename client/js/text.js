          ...
          (h = function (a, b) {
            var c = new java.io.File(a),
              ...
              c = new java.io.BufferedReader(
                new java.io.InputStreamReader(new java.io.FileInputStream(c), 'utf-8')
              ),
              d,
              f,
              e = '';
            try {
              ...
              for (d.append(f); (f = c.readLine()) !== null; ) (d.append(g), d.append(f));
              e = String(d.toString());
            } finally {
              c.close();
            }
    ...
    return (e = {
      ...
      parseName: function (a) {
        var b = !1,
          ...
          c = a.indexOf('!');
        c !== -1 &&
          ((b = a.substring(c + 1, a.length)), (b = b === 'strip'), (a = a.substring(0, c)));
